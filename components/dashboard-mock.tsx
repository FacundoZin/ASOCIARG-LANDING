...
export function DashboardMock() {
  return (
    <div className="flex h-full flex-col overflow-hidden bg-slate-50 relative">
      {/* Mobile Hardware Details (Simulación del Notch y barra de inicio) */}
      ...
      <div className="flex items-center gap-1.5 border-b border-slate-800 bg-slate-900 px-4 py-3 pt-6 sm:pt-3">
        ...
        <div className="flex h-5 sm:h-6 w-full max-w-[200px] sm:max-w-md items-center rounded-md bg-slate-800 px-2 sm:px-3 text-[8px] sm:text-[10px] text-slate-300/80 truncate mx-auto sm:ml-4">
          asociarg.cloud/dashboard
        </div>
      </div>

      <div 
        className="flex-1 overflow-auto p-3 sm:p-4 text-[10px] sm:text-[11px] custom-scrollbar relative z-10"
        aria-hidden="true"
      >
        {/* System Header */}
